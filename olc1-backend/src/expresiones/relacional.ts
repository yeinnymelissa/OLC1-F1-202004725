...
export class Relacional extends Expresion {
    ...
    public run(env: Entorno): Retorno {
      ...
      if (this.type == opcionesRelacionales.MAYOR) {
        ...
        if (nodoDer.type == Tipo.INT && nodoIzq.type == Tipo.INT) {
        ...
        }else if (this.type == opcionesRelacionales.MAYORIGUAL) {
          if (nodoDer.type == Tipo.INT && nodoIzq.type == Tipo.INT) {
            result = {
              value: nodoIzq.value >= nodoDer.value,
              type: Tipo.BOOLEAN,
          ...
          } else if (this.type == opcionesRelacionales.MENORIGUAL) {
            if (nodoDer.type == Tipo.INT && nodoIzq.type == Tipo.INT) {
              result = {
                value: nodoIzq.value <= nodoDer.value,
                type: Tipo.BOOLEAN,
          ...
          }else if (this.type == opcionesRelacionales.IGUAL) {
            if (nodoDer.type == Tipo.INT && nodoIzq.type == Tipo.INT) {
              result = {
                value: nodoIzq.value == nodoDer.value,
                type: Tipo.BOOLEAN,
            ...
            }else if(nodoIzq.type == Tipo.BOOLEAN && nodoDer.type == Tipo.BOOLEAN){
              result = {
                  value: nodoIzq.value == nodoDer.value,
                  type: Tipo.BOOLEAN,
                };
            }
          }else if (this.type == opcionesRelacionales.DIFERENTEDE) {
            if (nodoDer.type == Tipo.INT && nodoIzq.type == Tipo.INT) {
              result = {
                value: nodoIzq.value != nodoDer.value,
                type: Tipo.BOOLEAN,
